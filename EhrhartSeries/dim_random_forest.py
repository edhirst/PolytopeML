'''
Machine learning the dimension from the Hilbert series using a random forest
...
# random forest classifier. 1 random tree of max depth 3:
clf_dim = RandomForestClassifier(n_estimators=1, max_depth=3)
